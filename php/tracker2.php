...
<div class="overlay"></div>
  ...
  <div class="container h-100">
    <div class="d-flex h-100 text-center align-items-center">
      <div class="w-100 text-white">
        <h1 class="titulos">Tracking</h1>
        <h4 class="textos">Monitoreo de sus productos</h4>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="container-fluid">
        <section>
            ...
            <?php $Codigo = $_POST["codigo"];   ?>
              ...
              <center>
              <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-lightning-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <?php
                ...
                if( !(pg_num_rows($result) > 0) ){
                  if(   (substr($Codigo,strrpos($Codigo, '='),strrpos($Codigo, '='))  != "=")   ){
                  ?>
                  <center> <h4 class="textos">Producto no encontrado</h4> </center><br><br><br><br>
                  <?php
                  }
                }else if(pg_num_rows($result) > 1){
                    $quer = "SELECT codigo,tienda from Envio WHERE codigo ='$Codigo'";
                    $resul  = pg_query($quer);
                  ?>
                  <div class="container-fluid">
        <div class="row d-flex justify-content-center">
          ...
          <form action="" method="POST" id="formi">
            <div class="form-group" >
              ...
              <select name="codigo" id="select" class="form-control form-control-sm" required>
                  ...
                  $codigo="";
                  $tienda="";
                  while($line = pg_fetch_assoc($resul)){
                      $codigo = $line['codigo'];
                      $tienda = $line['tienda'];
                      ?>
                      <option value="<?php echo $codigo."=".$tienda?>"><?php echo $tienda; ?></option>
                    

                 <?php } ?>
                 </select>
                 </div>
                 <center> <button type="submit" name="submit"  class="btn btn-primary">Buscar</button> </center>
          </form>
    </div>
</div>
  ...
  <path fill-rule="evenodd" d="M9.5 1h-3a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3zm4.354 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
        ...
        <h4 class="textos">Orden nueva</h4>
  ...
  <path fill-rule="evenodd" d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l.5 2H5V5H3.14zM6 5v2h2V5H6zm3 0v2h2V5H9zm3 0v2h1.36l.5-2H12zm1.11 3H12v2h.61l.5-2zM11 8H9v2h2V8zM8 8H6v2h2V8zM5 8H3.89l.5 2H5V8zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z"/>
        ...
        <h4 class="textos">Surtiéndose</h4>
                </li>
                <li>
  ...
  <path fill-rule="evenodd" d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L10.404 2l-2.218-.887zm3.564 1.426L5.596 5 8 5.961 14.154 3.5l-2.404-.961zm3.25 1.7l-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923l6.5 2.6zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464L7.443.184z"/>
        ...
        <h4 class="textos">Empacandose</h4>
                </li>
                <li>
...
<i class="fa fa-times" ></i>
<h4 class="textos">Entregada</h4>
                </li>
                </ul>
</div>
            </div>
                 <?php }else if(intval($estado) == 2){ ?>
...
<h4 class="textos">Entregada</h4>
                 ...
                 <?php }else if( (intval($estado) > 5  ) && (substr($Codigo,strrpos($Codigo, '='),strrpos($Codigo, '='))  != "=")   ){?>
...
<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $es = substr($cod,0,strrpos($cod, '='));
      
      $se = substr($cod,strrpos($cod, '=') + 1);
     $tr = "SELECT estado from Envio WHERE codigo = '$es' AND tienda = '$se'";
      $ru = pg_query($tr);
      $esta =0;
      while($line = pg_fetch_assoc($ru)){
         $esta = $line["estado"];
      }
